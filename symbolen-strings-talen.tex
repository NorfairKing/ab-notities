...
\begin{st}
  ...
  \begin{proof}
    ...
    Merk op dat deze taal \emph{niet} regulier\deref{de:reguliere-taal} is. Er zitten immers haakjes in die moeten samen passen. (Zie verder waarom dit dan geen reguliere taal is (TODO)) 
