...
\begin{de}
  Een \term{grootste element} $a$ van een verzameling $A$ waarop een orderelatie $\prec$ gedefinieerd is, is een element waarvoor geldt dat alle andere elementen kleiner zijn of gelijk aan $a$.
