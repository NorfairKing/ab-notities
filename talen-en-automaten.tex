...
\TODO{ extra: complement van een NFA }
...
\TODO{bewijs}  
\question{hoe bewijs je dit en schrijf je het mooi op?}
\end{st}
...
\begin{st}
  ...
  \begin{proof}
    ...
    \end{enumerate}
    We bewijzen tenslotte dat $E$ de taal van de originele NFA bepaalt.
    \begin{itemize}
    \item Elke string $s$ die voor de reductie aanvaard werd door de NFA wordt ook door $E$ aanvaard.
    \item Elke string $s$ die voor de reductie niet aanvaard werd door de NFA wordt ook niet door $E$ aanvaard.
\TODO{bewijs}
    \end{itemize}
  \end{proof}
\end{st}
...
\TODO{ opmerking: $f$-gelijkheid geldt ook voor NFA's, maar $f$-verschillend wordt dan moeilijk te definieren.}
