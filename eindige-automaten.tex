...
\begin{de}
  ...
  In de eerste kolom staat een staat, in de tweede een symbool, en in de derde een verzameling van staten waarin je terecht kan komen vanuit de toestanden uit kolom 1 met symbolen uit kolom 2.                   
\end{de}
...
\begin{lem}
  ...
  \begin{proof}
    ...
    \question{Waarom is $|xy|$ zeker kleiner dan $d$?}
  \end{proof}
