...
\begin{de}
  De \term{taal} $L_{M}$ \term{bepaald door een NFA} $N$ bevat alle strings die $N$ aanvaardt, \textit{en geen andere strings}.
\end{de}
...
\clarify{ de NFA van een reguliere expressie bepaalt dezelfde taal. }
...
\begin{ei}
  ...
  \begin{proof}
    ...
    Bovendien bestaat er een functie die een willekeurige reguliere expressie afbeeldt op een reguliere expressie die dezelfde taal bepaalt en omgekeerd.\footnote{Zie stelling \ref{st:nfa-naar-regex}.}\footnote{Zie stelling \ref{st:regex-naar-NFA}.}
